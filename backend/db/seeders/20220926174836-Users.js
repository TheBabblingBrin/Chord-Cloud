...
module.exports = {
  ...
  async down (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkDelete("Users", {
        username: { [Op.in]: ["Demo-lition", "FakeUser1", "FakeUser2", 'FakeUser3', "SlySoJu",
                              "LilDBolagna", "DropKickKid", "DecentSized", "BowlingForBanhXeo","LalisaStan", "ChileanSeabas", "AlliThePokeTheif", "MikeyAllen27",] },
      },{});
  }
};
